    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          CardQuickSetting(judulQuickSetting: "Quick Settings Ruang Rektor"),
          for (var i = 0; i < 2; i++)
            CardQuickSetting(judulQuickSetting: "Quick Settings Ruang C.110"),
          for (var i = 0; i < 2; i++)
            CardQuickMonitoring(
                judulQuickMonitoring: "Quick Monitor Rung Rektor")
        ],
      ),
    );
  }
...
class CardQuickSetting extends StatelessWidget {
  ...
  const CardQuickSetting({Key? key, required this.judulQuickSetting})
      : super(key: key);
...
class CardQuickMonitoring extends StatelessWidget {
  ...
  const CardQuickMonitoring({Key? key, required this.judulQuickMonitoring})
      : super(key: key);
